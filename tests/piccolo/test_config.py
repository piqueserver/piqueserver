...
import unittest
from piccolo.config import ConfigStore, JSON_FORMAT, TOML_FORMAT
...
class TestExampleConfig(unittest.TestCase):
    ...
    def test_nested(self):
        ...
        self.assertEqual(raw['name'], 'piccolo instance')
    ...
    def test_nested_update(self):
        ...
        self.assertEqual(raw['server']['name'], 'piccolo instance')
