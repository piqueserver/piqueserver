...
from piccolo.config import (config, TOML_FORMAT, JSON_FORMAT,
...
def main():
    if (sys.version_info.major, sys.version_info.minor) not in SUPPORTED_PYTHONS:
        print('Warning: you are running on an unsupported Python version.\n'
              ...
              'Please see https://github.com/piccolo/piccolo/wiki/Supported-Environments for more information.')
    ...
    # - ~/.config/piccolo/config.toml
    # - ~/.config/piccolo/config.json
    format_ = None
